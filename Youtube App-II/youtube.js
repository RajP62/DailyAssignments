...
async function getTrendingData(){
    // GET https://youtube.googleapis.com/youtube/v3/videos?part=snippet&chart=mostPopular&maxResults=20&regionCode=IN&key=AIzaSyAnBaW48ziKnGqp-wJcZoZuyWom_CNt55M
    let body = await fetch(`https://youtube.googleapis.com/youtube/v3/videos?part=snippet&chart=mostPopular&maxResults=20&regionCode=IN&key=AIzaSyAnBaW48ziKnGqp-wJcZoZuyWom_CNt55M`);
    let res = await body.json();
